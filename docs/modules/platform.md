...
| `VersionedCache` | `Shared/Infrastructure/Cache` | Added 2026-09-19 (owner, Access spec amendment 6): moved from Platform's interior so Access, and later modules, cache by the same never-stale rule. |
