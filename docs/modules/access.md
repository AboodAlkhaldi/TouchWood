...
- The account is **locked at once** (it cannot order) and **anonymized 14 days later**. The customer
  is told once, when it is scheduled: the date, and that signing in cancels it (amendment 43).
