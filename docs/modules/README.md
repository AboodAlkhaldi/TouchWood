...
| Access | [approved](access.md), amendments 1–10 — being built, steps 1–2 of 7 (permission catalog; roles and the real permission check). See [its README](../../src/Modules/Access/README.md) | — |
| B2B | not started | — |
