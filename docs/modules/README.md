...
| Access | [approved](access.md), amendments 1–33 agreed, 34–35 proposed — being built, steps 1–3b of 8 (permission catalog; roles and the real permission check; staff accounts; staff lifecycle and sign-in). See [its README](../../src/Modules/Access/README.md) | — |
| B2B | not started | — |
