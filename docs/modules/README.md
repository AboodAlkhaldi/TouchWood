...
| Access | [approved](access.md), amendments 1–20 agreed, 21–24 proposed — being built, steps 1–3a of 8 (permission catalog; roles and the real permission check; staff accounts). See [its README](../../src/Modules/Access/README.md) | — |
| B2B | not started | — |
