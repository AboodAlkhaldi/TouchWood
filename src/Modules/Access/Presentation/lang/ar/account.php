...
return [
    ...
    */
    ...
    // B5 — أين أنت مسجَّل الدخول، وأي المتصفحات تتخطى رمزك (المالك، ٢٠٢٦-٠٩-٢٦).
    'sessions' => 'أين أنت مسجَّل الدخول',
    'sessions_hint' => 'كل متصفّح داخل إلى حسابك الآن. وإن لم تعرف واحدًا منها فأنهِه.',
    'this_browser' => 'هذا المتصفّح',
    'session_ip' => 'العنوان',
    'session_seen' => 'آخر استخدام',
    'unknown_device' => 'متصفّح غير معروف',
    'end_session' => 'تسجيل خروج هذا',
    'end_this_session' => 'تسجيل الخروج من هنا',
    ...
    'sign_out_everywhere_confirm' => 'سجّل الخروج من كل مكان',
    ...
    'forget_browser' => 'اطلب رمزًا من هذا',
    'forget_all_browsers' => 'اطلب رمزًا منها كلها',
