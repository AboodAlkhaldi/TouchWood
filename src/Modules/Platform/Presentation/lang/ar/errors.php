...
return [
    ...
    'media_not_found' => [
        ...
        'detail' => 'الملف المطلوب غير موجود.',
    ],
    'unsupported_media_type' => [
        'title' => 'نوع الملف غير مسموح',
        'detail' => 'يجب أن تكون الصور بصيغة JPEG أو PNG أو WebP، والمستندات بصيغة PDF أو JPEG أو PNG.',
    ],
    'media_too_large' => [
        'title' => 'حجم الملف كبير جدًا',
        'detail' => 'حجم الملف أكبر من الحد المسموح للرفع.',
    ],
    'media_in_use' => [
        'title' => 'الملف مستخدم',
    ...
    'invalid_media_variants_transition' => [
        ...
        'detail' => 'يمكن إعادة المحاولة فقط لصورة فشل إنشاء مقاساتها.',
    ],
    'invalid_media_attribute' => [
        'title' => 'بيانات الملف غير صالحة',
        'detail' => 'قيمة :attribute للملف غير صالحة.',
    ],
    'missing_translation' => [
        'title' => 'الترجمة ناقصة',
        'detail' => 'يجب إدخال :attribute باللغتين العربية والإنجليزية.',
    ],
    /* أسماء الحقول، للرفض الذي يسمّي حقلًا. */
    'fields' => [
        'bytes' => 'الحجم',
        'checksum' => 'بصمة الملف',
        'code' => 'الرمز',
        'country' => 'الدولة',
        'exponent' => 'عدد الخانات العشرية',
