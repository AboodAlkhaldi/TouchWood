...
Generated by `App\Http\Middleware\AssignCorrelationId` for every request — never taken from the
caller: an incoming `X-Correlation-Id` is ignored (owner's decision, 2026-09-18). Stored in
